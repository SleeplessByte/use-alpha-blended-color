...
exports.blend = exports.extract = exports.useAlphaBlendedColor = exports.blendColors = void 0;
var react_1 = require("react");
var RGBA_PATTERN = /rgba?\(([0-9]+),([0-9]+),([0-9]+)(?:,(1|0|0\.[0-9]*))?\)/;
function blendColors(foreground) {
    var colors = [];
...
function useAlphaBlendedColor(foreground) {
    var colors = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        colors[_i - 1] = arguments[_i];
    }
    return react_1.useMemo(function () { return blendColors.apply(void 0, __spreadArrays([foreground], colors)); }, [
        foreground,
        colors,
    ]);
}
exports.useAlphaBlendedColor = useAlphaBlendedColor;
...
function blend(_a, _b, premultiplied) {
